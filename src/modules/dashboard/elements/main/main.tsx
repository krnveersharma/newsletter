...
import SubscribersChart from '@/shared/components/cards/subscribers.chart';
        ...
        <div className="w-full flex justify-between">
          ...
          <div className="w-[35%]p-5">
            ...
            <p className="text-sm opacity-[.7]">
              Learn how to get started on InformedBox and utilize all our features,
